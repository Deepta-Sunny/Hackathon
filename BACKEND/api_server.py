...
async def start_attack_with_profile(profile: ChatbotProfile):
    ...
    print(f"Business Purpose: {profile.business_purpose or profile.primary_objective}")
    ...
    print(
        ...
        f"{profile.security_compliance_constraints or profile.boundaries}"
    )
    print("="*80 + "\n")
    # ===================================================
...
async def execute_attack_campaign(
    ...
    try:
        ...
        dashboard_info = {
            ...
            "business_purpose": (
                chatbot_profile.business_purpose or chatbot_profile.primary_objective
            ) if chatbot_profile else "",
            ...
            "security_compliance_constraints": (
                chatbot_profile.security_compliance_constraints or chatbot_profile.boundaries
            ) if chatbot_profile else "",
