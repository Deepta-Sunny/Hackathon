...
Write-Host "=====================================================================" -ForegroundColor Green
Write-Host ""
Write-Host "WebSocket Endpoint: ws://localhost:8005/ws" -ForegroundColor Cyan
Write-Host ""
Write-Host "Configuration:" -ForegroundColor Yellow
Write-Host "   Port: 8005" -ForegroundColor Gray
Write-Host "   Protocol: WebSocket (ws://)" -ForegroundColor Gray
Write-Host ""
Write-Host "WARNING: Make sure Azure OpenAI credentials are configured in:" -ForegroundColor Yellow
Write-Host "   config/settings.py" -ForegroundColor Gray
Write-Host ""
Write-Host "Press Ctrl+C to stop" -ForegroundColor Yellow
Write-Host ""

python chat_agent.py --port 8005